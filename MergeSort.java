...
/**
 * The first line contains an integer d, the number of datasets. Each of the
 * next d pairs of lines is as follows: The first line contains an integer n,
 * the number of elements in arr. The second line contains n space-separated
 * integers, arr[i].
 * 
 * @author kevinzeng
 */
