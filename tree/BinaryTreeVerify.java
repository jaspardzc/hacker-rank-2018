...
public class BinaryTreeVerify {
	...
	*/  
	    boolean checkBST(Node root) {
	    	return isNodeValid(root, Integer.MIN_VALUE, Integer.MAX_VALUE);
	    }
	    
	    boolean isNodeValid(Node root, int min, int max) {
	    	if (root == null) {
	    		return true;
	    	}
	    	...
	    	return isNodeValid(root.left, min, root.data-1) && isNodeValid(root.right, root.data+1, max);
	    }
}
